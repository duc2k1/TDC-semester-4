...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="btn btn-success" id="btnSignIn">Sign in</div>
      </div>
    </div>
  </nav>
  <div class="container">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body d-flex">
            <div>User name</div>
            <input type="text" name="" id="sign_in_user_name" style="width: 100%;">
          </div>
          <div class="btn btn-primary" id="btnSignInWeb" data-bs-dismiss="modal">Sign in</div>
        </div>
      </div>
    </div>
    <!-- Thong tin san pham -->
  ...
  <script src="./public/js/ajax_user.js"></script>
</body>
